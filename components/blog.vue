          ...
          <div class="container mx-auto px-6">
            ...
            >
              <div class="flex items-end justify-between flex-wrap gap-4">
                <div>
                  <span class="tag text-muted-foreground mb-4 block w-fit">Blog</span>
                ...
                <div class="grid md:grid-cols-2">
                  <div class="aspect-video md:aspect-auto overflow-hidden">
                    ...
                    <div class="absolute top-4 right-4">
                      <ArrowUpRightIcon class="w-8 h-8 text-muted-foreground group-hover:text-primary group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" />
                    </div>
                    
                    <div class="flex flex-wrap items-center gap-3 mb-6">
                      <span class="tag bg-primary/10 text-primary text-xs">Featured</span>
                      <span class="flex items-center gap-1.5 font-mono text-xs text-muted-foreground">
                        <CalendarIcon class="w-3 h-3"></CalendarIcon>
                        {{featuredPost.date}}
                      </span>
                    </div>
                    
                    <div class="text-2xl md:text-3xl lg:text-4xl font-display font-bold text-foreground group-hover:text-primary transition-colors mb-4">
                      {{featuredPost.title}}
                    </div>
